...
int da =  12,  // Left Front Pivot
    db =   12,  // Left Back Pivot
    dc =  12,  // Right Back Pivot
...
int l    = 0;
int r    = 0;
int spd  = 1;  // Speed of walking motion, larger the number, the slower the speed
...
void loop()
{
  ...
  high = 20;        // Set hight to 15
  spd = 15;          // Set speed to 3
